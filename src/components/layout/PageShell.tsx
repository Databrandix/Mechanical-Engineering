      ...
      <section className="relative min-h-[440px] md:min-h-[500px] w-full overflow-hidden flex flex-col pt-[110px] md:pt-[150px] pb-16">
        ...
        <div className="absolute bottom-6 md:bottom-8 left-0 w-full z-10">
          <Container className="!max-w-[1600px]">
            ...
            >
              {/* Inner pages keep Home on this site. Only the front page's own
                  hero sends Home up to the university — there it would
                  otherwise link to the page being read. */}
              <a
                href="/"
              ...
              {buildTrail(pathname, title).map((crumb, idx, all) => (
                <span key={`${crumb.label}-${idx}`} className="inline-flex items-center gap-2">
                  ...
                  {idx === all.length - 1 ? (
                    ...
                    /* A menu heading with no page behind it. Shown, so the
