      ...
      <Container>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-stretch">
            ...
            {researchAreas.map((area, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-6 rounded-2xl border border-primary/10 shadow-sm flex flex-col justify-center items-center text-center gap-4 transition-all"
                >
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="lg:w-1/3 relative rounded-[32px] overflow-hidden group shadow-2xl"
          >
            <img 
