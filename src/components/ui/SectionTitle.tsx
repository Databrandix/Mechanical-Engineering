...
export default function SectionTitle({title, subtitle, dark = false, centered = false}: SectionTitleProps) {
  return (
    <div className={`mb-6 md:mb-8 space-y-3 ${centered ? 'text-center' : ''}`}>
      <div className={`flex items-center gap-3 mb-2 ${centered ? 'justify-center' : ''}`}>
        ...
        <span className="text-accent font-bold tracking-[0.2em] uppercase text-[10px]">Academic Excellence</span>
      </div>
